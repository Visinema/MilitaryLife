...
export const COUNTRY_CONFIG: Record<CountryCode, CountryConfig> = {
  US: {
    ...
    promotionMinDays: [30, 45, 60, 75, 95, 120, 145, 185, 235, 295, 360, 9999],
    promotionMinPoints: [8, 12, 18, 24, 32, 40, 48, 58, 72, 88, 106, 9999]
  },
  ID: {
    country: 'ID',
    dailyEventProbability: 0.14,
    promotionMinDays: [36, 52, 70, 90, 115, 145, 170, 210, 260, 320, 390, 9999],
    promotionMinPoints: [10, 15, 21, 28, 36, 45, 54, 64, 78, 94, 112, 9999]
  }
};
