...
export const BRANCH_CONFIG: Record<BranchCode, BranchConfig> = {
  US_ARMY: {
    branch: 'US_ARMY',
    ranks: ['PV1', 'PV2', 'PFC', 'SPC', 'SGT', 'SSG', 'SFC'],
    salaryPerDayCents: [4200, 4500, 4900, 5400, 6200, 7100, 8100],
  ...
  US_NAVY: {
    branch: 'US_NAVY',
    ranks: ['SR', 'SA', 'SN', 'PO3', 'PO2', 'PO1', 'CPO'],
    salaryPerDayCents: [4300, 4700, 5100, 5600, 6500, 7400, 8500],
  ...
  ID_TNI_AD: {
    branch: 'ID_TNI_AD',
    ranks: ['Prada', 'Pratu', 'Praka', 'Kopda', 'Koptu', 'Serda', 'Sertu'],
    salaryPerDayCents: [1200, 1300, 1450, 1600, 1800, 2050, 2300],
  ...
  ID_TNI_AL: {
    branch: 'ID_TNI_AL',
    ranks: ['KLD', 'KLS', 'KLK', 'Kopda', 'Koptu', 'Serda', 'Sertu'],
    salaryPerDayCents: [1250, 1360, 1500, 1670, 1880, 2140, 2400],
