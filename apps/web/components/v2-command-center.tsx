  ...
  return (
    <div className="space-y-2.5">
      ...
      <section className="cyber-panel p-3">
        ...
        <div className="mt-2.5 grid gap-3 lg:grid-cols-[1.05fr,1fr]">
          <div className={`${mobileTab !== 'overview' ? 'hidden md:block' : ''}`}>
            <p className="mb-1.5 text-[11px] uppercase tracking-[0.12em] text-muted">Main Avatar Frame · Service Profile</p>
            <AvatarFrame
          ...
          <div className={`${mobileTab !== 'mission' ? 'hidden md:block' : ''} rounded-md border border-border/70 bg-bg/70 p-3`}>
            ...
            <div className="mt-3 rounded border border-accent/40 bg-accent/10 p-2.5">
